let visualDocument = function () {

    this.visualDocument = function () {

        it('Visual Document > jpg', function () {
            ...
            browser.sleep(9000)
            element(by.xpath("//div[3]//label[1]//img[1]")).click();
            browser.sleep(3000)
            element(by.xpath("//button[@class='btn btn-md btn-secondary']")).click();
            browser.sleep(2000)
            element(by.xpath("//input[@placeholder='Enter Title']")).click().sendKeys("quarto.jpg");
            browser.sleep(3000)
            ...
            browser.sleep(2000)
            //publish
            element(by.xpath("/html[1]/body[1]/root[1]/dashboard-layout[1]/div[1]/perfect-scrollbar[1]/div[1]/div[1]/div[1]/div[1]/div[1]/app-create-imagedocument[1]/section[1]/div[1]/div[1]/button[3]")).click();
            browser.sleep(3000)
            element(by.xpath("//button[@class='btn btn-secondary']")).click();
            browser.sleep(3000)
        ...
        it('Visual Document > png', function () {
            browser.actions().mouseMove(element(by.xpath("//i[@class='icon icon-add hvr-icon']"))).perform();
            browser.sleep(2000)
            element(by.xpath("//i[@class='icon icon-add hvr-icon']")).click();
            browser.sleep(3000)
            ...
            element(by.xpath("//button[@class='btn btn-md btn-secondary']")).click();
            browser.sleep(3000)
            element(by.xpath("//input[@placeholder='Enter Title']")).click().sendKeys("quarto.png");
            browser.sleep(3000)
            var path = require('path');
        ...
        it('Visual Document > gif', function () {
            browser.actions().mouseMove(element(by.xpath("//i[@class='icon icon-add hvr-icon']"))).perform();
            browser.sleep(3000)
            element(by.xpath("//i[@class='icon icon-add hvr-icon']")).click();
            browser.sleep(3000)
            ...
            element(by.xpath("//button[@class='btn btn-md btn-secondary']")).click();
            browser.sleep(3000)
            element(by.xpath("//input[@placeholder='Enter Title']")).click().sendKeys("quarto.gif");
            browser.sleep(3000)
            var path = require('path');
        ...
        it('Visual Document > bmp', function () {
            browser.actions().mouseMove(element(by.xpath("//i[@class='icon icon-add hvr-icon']"))).perform();
            browser.sleep(1000)
            element(by.xpath("//i[@class='icon icon-add hvr-icon']")).click();
            browser.sleep(2000)
            ...
            element(by.xpath("//button[@class='btn btn-md btn-secondary']")).click();
            browser.sleep(2000)
            element(by.xpath("//input[@placeholder='Enter Title']")).click().sendKeys("Visual_Doc_quarto.bmp");
            browser.sleep(2000)
            var path = require('path');
    ...
    this.visualDocAddQuiz = function () {
        ...
        it('Add-Quiz>1', function () {
            ...
            browser.sleep(3000)
            //Title
            element(by.xpath("//input[@placeholder='Enter Title']")).click().sendKeys("visualDocAddQuiz-1");
            browser.sleep(2000)
            var path = require('path');
            var fileToUpload = 'test_data/img/quarto.jpg',
            absolutePath = path.resolve(__dirname, fileToUpload);
            ...
            browser.sleep(1000)
            //ADD-QUIZ
            element(By.xpath("/html[1]/body[1]/root[1]/dashboard-layout[1]/div[1]/perfect-scrollbar[1]/div[1]/div[1]/div[1]/div[1]/div[1]/app-create-imagedocument[1]/section[1]/form[1]/div[1]/div[2]/div[1]/div[2]/button[1]")).click();
            browser.sleep(3000)
            //Question-1
        ...
        //     browser.sleep(2000)
        //     //title
        //     element(by.xpath("//input[@placeholder='Enter Title']")).click().sendKeys("visualDocAddQuiz-2");
        //     browser.sleep(2000)
        //     var path = require('path');
        //     var fileToUpload = 'test_data/img/quarto.jpg',
        //     absolutePath = path.resolve(__dirname, fileToUpload);
...
module.exports = new visualDocument();